        ...
        <div class="row g-3 mb-4 justify-content-center">
                ...
                <a href="{{ route('projects.index', ['status' => 'DRAFT']) }}" class="text-decoration-none">
                    <div class="card bg-secondary text-white h-100 shadow-sm hover-scale">
                        <div class="card-body text-center px-2">
                            <h6 class="card-subtitle mb-2 text-white-50" style="font-size: 0.8rem;">Draf Saya</h6>
            ...
            <div class="col-6 col-md-4 col-lg">
                <a href="{{ route('projects.index', ['status' => 'PUBLISHED']) }}" class="text-decoration-none">
                    <div class="card bg-info text-white h-100 shadow-sm hover-scale">
                        <div class="card-body text-center px-2">
                            <h6 class="card-subtitle mb-2 text-white-50" style="font-size: 0.8rem;">Proyek Terbuka</h6>
            ...
            <div class="col-6 col-md-4 col-lg">
                <div class="card bg-info text-white h-100 shadow-sm">
                    <div class="card-body text-center px-2">
                        <h6 class="card-subtitle mb-2 text-white-50" style="font-size: 0.8rem;">Skor</h6>
                        <h2 class="card-title mb-0">{{ auth()->user()->auditor->performance_score ?? 0 }}</h2>
                        <small class="d-block mt-1 text-white-50" style="font-size: 0.7rem;">(Penilaian Anda)</small>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Proyek Aktif Saya</h5>
                        </div>
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-info">
                        <h5>Tidak Ada Proyek Aktif</h5>
                        <p class="mb-0">Anda tidak memiliki proyek aktif saat ini.</p>
                    </div>
                </div>
            </div>
        @endif
