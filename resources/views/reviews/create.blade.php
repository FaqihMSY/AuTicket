...
@section('title', 'Review & Close Project')

@section('content')
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2>Review & Close Project</h2>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   placeholder="Auto-calculated from 4 scores below"
                                   readonly
                                   required>
                            @error('reviews.'.$index.'.overall_rating')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <input type="hidden" name="reviews[{{ $index }}][reviewee_id]" value="{{ $auditor->user->id }}">
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="timeliness_rating_{{ $auditor->id }}" class="form-label">Timeliness</label>
                                <input type="number" 
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="completeness_rating_{{ $auditor->id }}" class="form-label">Completeness</label>
                                <input type="number" 
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="quality_rating_{{ $auditor->id }}" class="form-label">Quality</label>
                                <input type="number" 
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="communication_rating_{{ $auditor->id }}" class="form-label">Communication</label>
                                <input type="number" 
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary btn-lg" onclick="return confirm('Submit reviews and close this project? This action cannot be undone.');">
                                <i class="bi bi-check-circle"></i> Submit Reviews & Close Project
                            </button>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled small mb-0">
                        ...
                        <li><strong>&lt;60:</strong> Needs Improvement</li>
                    </ul>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!valid) {
            e.preventDefault();
            alert('Please fill all detailed scores (0-100) for all auditors.');
            return false;
        }
    });
